...
CONF_ZALO_INVOCATION_KEYWORD_ENABLED = "zalo_invocation_keyword_enabled"
CONF_ZALO_INVOCATION_KEYWORD = "zalo_invocation_keyword"
...
CONF_CALENDAR_SOLAR_ENTITY_ID = "calendar_solar_entity_id"
CONF_CALENDAR_LUNAR_ENTITY_ID = "calendar_lunar_entity_id"
...
DEFAULT_ZALO_INVOCATION_KEYWORD_ENABLED = True
DEFAULT_ZALO_INVOCATION_KEYWORD = "@1080"
...
WEATHER_SERVICE_GET_FORECASTS = "get_forecasts"
...
YOUTUBE_CAST_DOWNLOAD_TIMEOUT_SECONDS = 8 * 60
YOUTUBE_CAST_FILE_TTL_SECONDS = 8 * 60 * 60
...
YT_DLP_DOMAIN = "yt_dlp"
YT_DLP_SERVICE_PLAY = "play"
YT_DLP_PLAY_VERIFY_TIMEOUT_SECONDS = 25
...
HELP_SENTENCES = [
    ...
    "[hãy ](xem|danh sách|liệt kê) [các ]lệnh [của ]tích hợp",
    "[hãy ]xem danh sách [các ]lệnh [của ]tích hợp",
    "[hãy ]cho [tôi ]xem [các ]lệnh [của ]tích hợp",
